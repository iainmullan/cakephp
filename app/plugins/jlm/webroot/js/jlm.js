...
return ltrim(rtrim(str,chars),chars);}};$.jlm.bind('app_controller.beforeFilter',function(){});$.jlm.bind('pages.display',function(){$('#map').attr('style',$('#map').attr('style')+'background-color:red;');});